...
public class S extends BaseShape {

    /**
     * Shape ID for this object type
     */
    private static final Shape id = Shape.S;
    ...
    public S(boolean next, int level) {
        super(tileCount);
    ...
    private IRotateAction getRotationActionZero() {
        return board -> {
            ...
            tile1 = tiles[0];
            if (!verifyTilePotentialRotation(tile1, 0, 2, board, null)) return false;
            tile2 = tiles[1];
